...
The model converged smoothly over 100 epochs (Figure \ref{fig:training}), with training and validation losses decreasing monotonically without overfitting. Final MSE: Training $5.2 \times 10^{-8}$, Validation $6.1 \times 10^{-8}$.
